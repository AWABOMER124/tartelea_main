      ...
      <div className="flex items-center justify-center gap-2.5 max-w-md mx-auto">
        ...
        {(isSpeaker || isHost) && (
          <Button
            ...
            size="icon"
            className="h-14 w-14 rounded-[10px] shadow-md"
        ...
        {isHost && (
          <Button
            ...
            size="icon"
            className={`h-11 w-11 rounded-[10px] ${isRecording ? "ring-2 ring-destructive ring-offset-1 ring-offset-card" : ""}`}
        ...
        <Button
          variant="ghost"
          className="h-11 px-4 rounded-[10px] bg-destructive/10 hover:bg-destructive/20 text-destructive"
          onClick={onLeave}
        >
