...
const EMAIL_SUBJECTS: Record<string, string> = {
  signup: 'تأكيد بريدك الإلكتروني — المدرسة الترتيلية',
  invite: 'دعوة للانضمام — المدرسة الترتيلية',
  magiclink: 'رابط تسجيل الدخول — المدرسة الترتيلية',
  recovery: 'إعادة تعيين كلمة المرور — المدرسة الترتيلية',
  email_change: 'تأكيد تغيير البريد الإلكتروني — المدرسة الترتيلية',
  reauthentication: 'رمز التحقق — المدرسة الترتيلية',
}
...
// Configuration
const SITE_NAME = "tartelea"
const SENDER_DOMAIN = "notify.tartelea.com"
const ROOT_DOMAIN = "tartelea.com"
const FROM_DOMAIN = "tartelea.com" // Domain shown in From address (may be root or sender subdomain)
...
const SAMPLE_PROJECT_URL = "https://tartelea.lovable.app"
